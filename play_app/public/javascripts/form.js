...
function submit() {
    ...
    var tour = {name:tName, startTime:tStartTime, description: tDesc, totalDescription:totalDesc, audioURL:tAudio, videoURL:tVideo, latitude:tLatitude, longitude:tLongitude, tourGuideName:tGuideName, signed_up:"0"};
